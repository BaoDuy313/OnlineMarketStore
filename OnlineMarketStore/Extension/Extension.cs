...
namespace OnlineMarketStore.Extension
{
    public static class Extension
    {
        public static string ToVnd(this double totalPrice)
        {
            return totalPrice.ToString("#,##0") + "VND";
        }
        ...
        public static string ToUrlFriendly(this string url)
        {
            ...
            result = Regex.Replace(result, "úùụủũ", "u");
