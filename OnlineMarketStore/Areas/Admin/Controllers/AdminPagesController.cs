...
namespace OnlineMarketStore.Areas.Admin.Controllers
{
   ...
   [Authorize]
    public class AdminPagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PageId,PageName,Contents,Thumb,Published,Title,CreatedDate,Ordering,Alias")] Page page, Microsoft.AspNetCore.Http.IFormFile fThumb)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PageId,PageName,Contents,Thumb,Published,Title,CreatedDate,Ordering,Alias")] Page page, Microsoft.AspNetCore.Http.IFormFile fThumb)
        {
            if (id != page.PageId)
            {
                return NotFound();
